...
public class MainActivity extends AppCompatActivity {
    ...
    private final ArrayList<Pair<Integer, Integer>> Filters = new ArrayList<>(Arrays.asList(
            ...
            new Pair<>(R.raw.glasses1, R.drawable.clownface),
            new Pair<>(R.raw.glasses1, R.drawable.catface),
            new Pair<>(R.raw.glasses1, R.drawable.dogface),
            new Pair<>(R.raw.glasses1, R.drawable.mouseface),
            new Pair<>(R.raw.glasses3, R.drawable.lipsandglass)));
